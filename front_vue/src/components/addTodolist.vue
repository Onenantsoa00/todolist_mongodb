<template>
  <div class="text-2xl font-bold">New Task</div>
  ...
  <div class="relative mb-6">
    ...
    <input
      ...
      placeholder="ex: MongoDB Project"
      v-model="models.add_task.nom"
    />
  </div>
  <label
    for="website-admin"
    ...
    >
      ...
      <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
        ...
        <textarea
          ...
          v-model="models.add_task.description"
        ></textarea>
      </div>
    </div>
  </form>
  ...
  <button
    type="button"
    class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mt-3"
    @click="add_task"
  >
    Add Task
  </button>
...
export default {
  ...
  methods: {
    add_task() {
      axios
        .post(
          `http://localhost:3020/api/v1/todolistRouter/todolist_create`,
          this.models.add_task
        )
        .then((res) => {
          this.models.add_task = {
            nom: "",
