...
router.get(
  "/filtrage_by_name_decroissant",
  controller.triage_par_nom_decroissant
);
router.get("/filtrage_par_status", controller.filtrage_par_status);
router.get(
  "/filtrage_par_status_decroissant",
  controller.filtrage_par_status_decroissant
);
